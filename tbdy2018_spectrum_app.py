...
x = st.sidebar.number_input("Longitude (Range: 26.00 - 45.00)",value=29.01, step=0.01)
y = st.sidebar.number_input("Latitude: (Range: 36.00 - 42.00)",value=41.10, step=0.01)
...
if limit_ratio < ratio_ :
    st.sidebar.info("Displacement Ratio: " + str(format(ratio_ , ".3f")))
    st.sidebar.info("Displacement Limit Ratio: " + str(limit_ratio))
